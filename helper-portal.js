...
async function init() {
  ...
  $('payrollRows').innerHTML = rows.map((item) => `
    <tr>
      ...
      <td><a class="portal-action-link" href="receipt.html?type=payroll&id=${encodeURIComponent(item.payroll_id)}&portal=1" target="_blank" rel="noopener noreferrer">রিসিট দেখুন</a></td>
    </tr>
